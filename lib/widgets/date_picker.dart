    ...
    final Widget yearButton = IgnorePointer(
      ...
      child: _DateHeaderButton(
        ...
        child: Semantics(
          ...
          child: Text(localizations.formatYear(selectedDates.last), style: yearStyle),
        ),
      ),
    );
    ...
    final Widget dayButton = IgnorePointer(
      ...
      child: _DateHeaderButton(
        ...
        child: Semantics(
          ...
          child: Text(localizations.formatMediumDate(selectedDates.last), style: dayStyle),
        ),
      ),
    );
...
class _YearPickerState extends State<YearPicker> {
  ...
  void initState() {
    ...
    scrollController = ScrollController(
      ...
      initialScrollOffset: (widget.selectedDates.last.year - widget.firstDate.year) * _itemExtent,
    );
  }
    ...
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return InkWell(
          ...
          onTap: () {
            widget.onChanged(DateTime(year, widget.selectedDates.last.month, widget.selectedDates.last.day));
          },
          child: Center(
            child: Semantics(
              selected: isSelected,
...
Future<List<DateTime>> showMultiDatePicker({
  ...
  assert(!initialDates.first.isBefore(firstDate), 'initialDate must be on or after firstDate');
  assert(!initialDates.last.isAfter(lastDate), 'initialDate must be on or before lastDate');
