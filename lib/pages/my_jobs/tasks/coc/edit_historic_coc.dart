...
class EditHistoricCoc extends StatefulWidget {
  EditHistoricCoc({Key key, this.acm}) : super(key: key);
  final String acm;
...
class _EditHistoricCocState extends State<EditHistoricCoc> {
  // TODO: Historic Coc will allow image/PDF upload or photo
  // TITLE
  String _title;
...
//  String initialSurface;
  ...
  Widget build(BuildContext context) {
    ...
    print('Average: ' +
        ((priorityActivity + 0.9) / i).round().toString() +
        'Activity: ' +
        priorityActivity.toString() +
        ', Counter: ' +
        i.toString() +
        ' PriorityRisk ' +
    ...
    if (priorityDisturbanceAccessibility != null) {
      priorityDisturbance =
          priorityDisturbance + priorityDisturbanceAccessibility;
      i = i + 1;
    }
    ...
    print('Average: ' +
        ((priorityDisturbance + 0.9) / i).round().toString() +
        'Disturbance: ' +
        priorityDisturbance.toString() +
        ', Counter: ' +
        i.toString() +
        ' PriorityRisk ' +
        priorityRiskScore.toString());
                            ...
                            new Container(
                              ...
                              children: <Widget>[
                                ...
                                new Container(
                                    ...
                                    child: ScoreButton(
                                      bordercolor: materialRiskSet
                                          ? Colors.black26
                                          : Colors.white,
                                      onClick: () {},
                                      selected: true,
                                      score: materialRiskSet
                                          ? materialRiskLevel
                                          : -1,
                                      textcolor: Colors.black54,
                                      text: materialRiskSet
                                          ? materialRiskText
                                          : 'Incomplete',
                                      radius: 0.0,
                                    )),
                                          ...
                                          new Expanded(
                                            child: new ScoreButton(
                                              onClick: () {
                                                // firestore change score
                                                setState(() {
                                                  if (materialProductScore ==
                                                      1) {
                                                    materialProductScore = null;
                                                  } else {
                                                    materialProductScore = 1;
                                                  }
                                                  acmObj["materialrisk_productscore"] =
                                                      materialProductScore;
                                          ...
                                          new Expanded(
                                            child: new ScoreButton(
                                              onClick: () {
                                                // firestore change
                                                setState(() {
                                                  if (materialDamageScore ==
                                                      0) {
                                                    materialDamageScore = null;
                                                  } else {
                                                    materialDamageScore = 0;
                                                  }
                                                  acmObj["materialrisk_damagescore"] =
                                                      materialDamageScore;
                                          ...
                                          new Expanded(
                                            child: new ScoreButton(
                                              onClick: () {
                                                // firestore change score
                                                setState(() {
                                                  if (materialSurfaceScore ==
                                                      0) {
                                                    materialSurfaceScore = null;
                                                  } else {
                                                    materialSurfaceScore = 0;
                                                  }
                                                  acmObj["materialrisk_surfacescore"] =
                                                      materialSurfaceScore;
                                          ...
                                          new Expanded(
                                            child: new ScoreButton(
                                              onClick: () {
                                                // firestore change score
                                                setState(() {
                                                  if (materialAsbestosScore ==
                                                      1) {
                                                    materialAsbestosScore =
                                                        null;
                                                  } else {
                                                    materialAsbestosScore = 1;
                                                  }
                                                  acmObj["materialrisk_asbestosscore"] =
                                                      materialAsbestosScore;
                              ...
                              children: <Widget>[
                                ...
                                new Container(
                                    ...
                                    padding:
                                        EdgeInsets.symmetric(horizontal: 4.0),
                                    child: ScoreButton(
                                      bordercolor: priorityRiskSet
                                          ? Colors.black26
                                          : Colors.white,
                                      onClick: () {},
                                      selected: true,
                                      score: priorityRiskSet
                                          ? priorityRiskLevel
                                          : -1,
                                      textcolor: Colors.black54,
                                      text: priorityRiskSet
                                          ? priorityRiskText
                                          : 'Incomplete',
                                      radius: 0.0,
                                    )),
                                          ...
                                          new Expanded(
                                            child: new ScoreButton(
                                              onClick: () {
                                                // firestore change score
                                                setState(() {
                                                  if (priorityActivityMain ==
                                                      0) {
                                                    priorityActivityMain = null;
                                                  } else {
                                                    priorityActivityMain = 0;
                                                  }
                                                  acmObj["priority_activity_main"] =
                                                      priorityActivityMain;
                                          ...
                                          new Expanded(
                                            child: new ScoreButton(
                                              onClick: () {
                                                // firestore change score
                                                setState(() {
                                                  if (priorityActivitySecond ==
                                                      0) {
                                                    priorityActivitySecond =
                                                        null;
                                                  } else {
                                                    priorityActivitySecond = 0;
                                                  }
                                                  acmObj["priority_activity_second"] =
                                                      priorityActivitySecond;
                                          ...
                                          new Expanded(
                                            child: new ScoreButton(
                                              onClick: () {
                                                // firestore change score
                                                setState(() {
                                                  if (priorityDisturbanceLocation ==
                                                      0) {
                                                    priorityDisturbanceLocation =
                                                        null;
                                                  } else {
                                                    priorityDisturbanceLocation =
                                                        0;
                                                  }
                                                  acmObj["priority_disturbance_location"] =
                                                      priorityDisturbanceLocation;
                                              ...
                                              score: 0,
                                              tooltip: Tip
                                                  .priority_disturbance_location_0,
                                            ),
                                          ),
                                          new Expanded(
                                            child: new ScoreButton(
                                              ...
                                              score: 1,
                                              tooltip: Tip
                                                  .priority_disturbance_location_1,
                                            ),
                                          ),
                                          new Expanded(
                                            child: new ScoreButton(
                                              ...
                                              score: 2,
                                              tooltip: Tip
                                                  .priority_disturbance_location_2,
                                            ),
                                          ),
                                          new Expanded(
                                            child: new ScoreButton(
                                              ...
                                              score: 3,
                                              tooltip: Tip
                                                  .priority_disturbance_location_3,
                                            ),
                                          ),
                                        ],
                                      ),
                                          ...
                                          new Expanded(
                                            child: new ScoreButton(
                                              onClick: () {
                                                // firestore change score
                                                setState(() {
                                                  if (priorityDisturbanceAccessibility ==
                                                      0) {
                                                    priorityDisturbanceAccessibility =
                                                        null;
                                                  } else {
                                                    priorityDisturbanceAccessibility =
                                                        0;
                                                  }
                                                  acmObj["priority_disturbance_accessibility"] =
                                                      priorityDisturbanceAccessibility;
                                              ...
                                              score: 0,
                                              tooltip: Tip
                                                  .priority_disturbance_accessibility_0,
                                            ),
                                          ),
                                          new Expanded(
                                            child: new ScoreButton(
                                              ...
                                              score: 1,
                                              tooltip: Tip
                                                  .priority_disturbance_accessibility_1,
                                            ),
                                          ),
                                          new Expanded(
                                            child: new ScoreButton(
                                              ...
                                              score: 2,
                                              tooltip: Tip
                                                  .priority_disturbance_accessibility_2,
                                            ),
                                          ),
                                          new Expanded(
                                            child: new ScoreButton(
                                              ...
                                              score: 3,
                                              tooltip: Tip
                                                  .priority_disturbance_accessibility_3,
                                            ),
                                          ),
                                        ],
                                      ),
                                          ...
                                          new Expanded(
                                            child: new ScoreButton(
                                              onClick: () {
                                                // firestore change score
                                                setState(() {
                                                  if (priorityDisturbanceExtent ==
                                                      0) {
                                                    priorityDisturbanceExtent =
                                                        null;
                                                  } else {
                                                    priorityDisturbanceExtent =
                                                        0;
                                                  }
                                                  acmObj["priority_disturbance_extent"] =
                                                      priorityDisturbanceExtent;
                                          ...
                                          new Expanded(
                                            child: new ScoreButton(
                                              onClick: () {
                                                // firestore change score
                                                setState(() {
                                                  if (priorityExposureOccupants ==
                                                      0) {
                                                    priorityExposureOccupants =
                                                        null;
                                                  } else {
                                                    priorityExposureOccupants =
                                                        0;
                                                  }
                                                  acmObj["priority_exposure_occupants"] =
                                                      priorityExposureOccupants;
                                          ...
                                          new Expanded(
                                            child: new ScoreButton(
                                              onClick: () {
                                                // firestore change score
                                                setState(() {
                                                  if (priorityExposureUseFreq ==
                                                      0) {
                                                    priorityExposureUseFreq =
                                                        null;
                                                  } else {
                                                    priorityExposureUseFreq = 0;
                                                  }
                                                  acmObj["priority_exposure_usefreq"] =
                                                      priorityExposureUseFreq;
                                          ...
                                          new Expanded(
                                            child: new ScoreButton(
                                              onClick: () {
                                                // firestore change score
                                                setState(() {
                                                  if (priorityExposureAvgTime ==
                                                      0) {
                                                    priorityExposureAvgTime =
                                                        null;
                                                  } else {
                                                    priorityExposureAvgTime = 0;
                                                  }
                                                  acmObj["priority_exposure_avgtime"] =
                                                      priorityExposureAvgTime;
                                          ...
                                          new Expanded(
                                            child: new ScoreButton(
                                              onClick: () {
                                                // firestore change score
                                                setState(() {
                                                  if (priorityMaintType == 0) {
                                                    priorityMaintType = null;
                                                  } else {
                                                    priorityMaintType = 0;
                                                  }
                                                  acmObj["priority_maint_type"] =
                                                      priorityMaintType;
                                          ...
                                          new Expanded(
                                            child: new ScoreButton(
                                              onClick: () {
                                                // firestore change score
                                                setState(() {
                                                  if (priorityMaintFreq == 0) {
                                                    priorityMaintFreq = null;
                                                  } else {
                                                    priorityMaintFreq = 0;
                                                  }
                                                  acmObj["priority_maint_freq"] =
                                                      priorityMaintFreq;
