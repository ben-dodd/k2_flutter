  ...
  Widget build(BuildContext context) {
    if (widget.doc['idkey'] == 'i') {
      ...
      if (widget.doc['samplenumber'] != null) {
        ...
        symbol = 'S*';
        subtitle =
            'Strongly presumed as historic sample ' + widget.doc['historic'];
      } else {
        symbol = 'S';
                          ...
                          ? new InkWell(
                              child: new Container(
                                ...
                                decoration: new BoxDecoration(
                                  color: Colors.white,
                                  border:
                                      new Border.all(color: pColor, width: 2.0),
                                  borderRadius: new BorderRadius.circular(30.0),
                                ),
                                child: new Text(
                                  widget.doc['pRiskLevel'] < 0 ? '!' : 'P',
                                  style: new TextStyle(
                                      fontSize: 16.0, color: pColor),
                                ),
                              ),
                            )
                          : new Container(
                          ...
                          ? new InkWell(
                              child: new Container(
                                ...
                                decoration: new BoxDecoration(
                                  color: Colors.white,
                                  border:
                                      new Border.all(color: mColor, width: 2.0),
                                  borderRadius: new BorderRadius.circular(30.0),
                                ),
                                child: new Text(
                                  widget.doc['mRiskLevel'] < 0 ? '!' : 'M',
                                  style: new TextStyle(
                                      fontSize: 16.0, color: mColor),
                                ),
                              ),
                            )
                          : new Container(
                      ...
                      hasPhoto
                          ? photoSynced
                              ...
                              : Icon(Icons.camera_alt,
                                  color: CompanyColors.checkMaybe)
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      isRunning
                          ...
                          : Container(),
                      isComplete
                          ? Icon(Icons.done, color: CompanyColors.checkYes)
                          : Container(),
//           new InkWell(
//            child: new Container(
//              height: 30.0,
