...
Offset transformPoint(Offset p, Offset o, double scale, double rotation, double translateX, double translateY) {
...
//    print ('Distance; ' + distance.toString());
  return Offset(q.dx + ((sqrt(dx*dx + dy*dy)) * cos(angle)), q.dy + ((sqrt(dx*dx + dy*dy)) * sin(angle)));
}
